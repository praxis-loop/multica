...
func TestParseProjectCommand(t *testing.T) {
	tests := []struct {
		...
		{name: "issue bind", body: "/issue bind MUL-123", ok: true, resource: "issue", action: "bind", args: []string{"MUL-123"}, raw: "MUL-123"},
		{name: "upstream issue create", body: "/issue Fix login", ok: false},
		{name: "upstream bare issue", body: "/issue", ok: false},
		{name: "unrecognized issue action", body: "/issue frobnicate MUL-123", ok: false},
